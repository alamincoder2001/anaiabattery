	...
	<div class="row">
		<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
			<div class="form-group" style="margin-top:10px;">
				...
				<div class="col-xs-3"> 
					<v-select v-bind:options="serial_list" v-model="selectedSerial" label="Batch_Serial"></v-select>
				</div>
            </div> 
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			async getStock(){
				await axios.post('/get_serial_report',{serial:this.selectedSerial.id})
				.then((res)=>{
