	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group" style="margin-top:10px;">
			...
			<div class="col-sm-2">
                ...
                <?php $returning_imeis =  $this->db->query("SELECT ps_imei_number,ps_prod_id FROM  tbl_product_serial_numbers WHERE ps_brunch_id=? AND  ps_s_r_status='no' OR ps_s_r_status=null",$this->session->userdata('BRANCHid'))->result(); 
...
<script>
     $(document).on('change','#imei_number',function(){
        ...
        $.ajax({
            url:"<?= base_url()?>Administrator/Sales/get_return_imei_number",
            method:"POST",
     ...
     $(document).on('click','#parchase_return_btn',function(){
            ...
            axios.post('/sale_imei_return',{imei_number:imei_number,return_amout:return_amout,prod_id:prod_id})
            .then((res)=>{
                if (res.data=='return') {
