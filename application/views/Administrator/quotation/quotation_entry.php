						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" id="discount" placeholder="Qty" class="form-control" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required/>
									</div>
								</div>
								<div class="form-group"> 
	...
	new Vue({
		...
		methods:{
			...
			productTotal(){
				...
				var numVal2 = this.selectedProduct.discount;
