...
<div class="col-xs-12">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" id="batchname" name="batchname" placeholder="Batch Serial" value="<?php echo $selected->Batch_Serial; ?>" class="col-xs-10 col-sm-4" />
...
<script type="text/javascript">
    function submit(){
        ...
        var inputdata = 'batchname='+batchname+'&id='+id;
        var urldata = "<?php echo base_url(); ?>batchupdate";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputdata,
...
<script type="text/javascript">
    function deleted(id){
        ...
        var urldata = "<?php echo base_url();?>Administrator/page/batchdelete";
		if(confirmation){
        $.ajax({
            type: "POST",
            url: urldata,
