		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			...
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="number" step="0.01" min='0' class="form-control" v-model="product.Product_Warranty" required>
					</div>
				</div>
				<div class="form-group clearfix">
					...
					<datatable :columns="columns" :data="products" :filter-by="filter">
						<template scope="{ row }">
							<tr>
								...
								<td>{{ row.vat }}</td>
								<td>{{ row.Product_Warranty == 1 ? row.Product_Warranty + ' month': row.Product_Warranty > 0 ? row.Product_Warranty+' months':'-' }}</td>
...
<script>
	...
	new Vue({
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Warranty', field: 'Product_Warranty', align: 'center' },
		...
		methods:{
			...
			// 	let checkmonth = month == 0 ? "":month+' month';
			// 	let checkyear = year == 1 ? year+' year ':year+' years ';
